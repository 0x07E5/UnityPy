...
class Mesh(NamedObject):
  ...
  m_Shapes: Optional[Union[List[MeshBlendShape], BlendShapeData]] = None
...
@define(kw_only=True, slots=False)
class OffsetPtr:
  data: Union[TransitionConstant, ValueArray, Blend2dDataConstant, Hand, BlendDirectDataConstant, HumanLayerConstant, SelectorTransitionConstant, BlendTreeNodeConstant, ValueArrayConstant, Human, BlendTreeConstant, SkeletonPose, ConditionConstant, SkeletonMask, StateMachineConstant, SelectorStateConstant, LayerConstant, Clip, StateConstant, Blend1dDataConstant, Skeleton]
...
class TilemapRefCountedData:
  m_Data: Union[ColorRGBA, PPtr[GameObject], Matrix4x4f, PPtr[Object], PPtr[Sprite]]
  m_RefCount: int
...
class VFXEntryExposed:
  m_Name: str
  m_Overridden: bool
  m_Value: Union[bool, int, float, Gradient, Vector3f, Vector4f, AnimationCurve, Matrix4x4f, Vector2f, PPtr[Object], PPtr[NamedObject]]
